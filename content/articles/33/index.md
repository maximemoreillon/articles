...
Now that we've cleared some basic theory about APIs, let's go through some practical examples. Here, we are going to take our _area_of_circle_ function and expose it using a REST API so that other applications can access it.
