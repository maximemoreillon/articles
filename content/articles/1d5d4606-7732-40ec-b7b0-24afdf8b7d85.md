...
This exposes CRUD operations for each table via a REST API. For example, a new record in the table named _project_ can be created using a POST request to the `/project` route.
