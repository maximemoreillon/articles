...
The configuration of the TypeScript compiler is achieved using a file called tsconfig.json. Creating such file can be done using the following tsc command:
