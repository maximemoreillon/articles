...
In order to run tests easily, let's configure the _npm run test_ command to perform the necessary actions. To do so, we edit the package.json file at the scripts section, where the original content should like this:
