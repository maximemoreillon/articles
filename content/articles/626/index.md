...
![](61a61db34b39956825dae7b4.png)

## Creating an index file for the chart

Artifact Hub requires an *index.yaml* file to be present in the chart's directory. This file contains information about the chart and is created automatically by running the following command:
